...
namespace CoreporateAPI.Persistence.Services
{
    public class AuthorizationEndpointService : IAuthorizationEndpointService
    {
        ...
        public AuthorizationEndpointService(IApplicationService applicationService, IEndpointReadRepository endpointReadRepository, IEndpointWriteRepository endpointWriteRepository, IEndpointMenuReadRepository endpointMenuReadRepository, IEndpointMenuWriteRepository endpointMenuWriteRepository = null)
        {
